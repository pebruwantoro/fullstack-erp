    ...
    return <>
        <div className="animate-fade-in bg-gray-800 bg-opacity-80 p-8 rounded-xl shadow-custom border border-gray-700 backdrop-blur-sm w-full max-w-md">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-300 mt-2">Register account</p>
            </div>
            <form onSubmit={handleSubmit}>
                ...
                >
                    <i className="fas fa-user mr-2" /> Create Account
                </button>
                </div>
                ...
                <div className="text-center">
                    <p className="text-gray-400">Do you have an account? <Link to="/login" className="text-blue-400 hover:text-blue-300">Login account</Link></p>
                </div>
            </form>
        </div>
    </>
